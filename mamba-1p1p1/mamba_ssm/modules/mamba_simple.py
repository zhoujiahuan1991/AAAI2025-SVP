...
class Mamba(nn.Module):
    def __init__(
        ...
        self.d_conv = d_conv
        self.expand = expand
        self.d_inner = int(self.expand * self.d_model)   # 768
        self.dt_rank = math.ceil(self.d_model / 16) if dt_rank == "auto" else dt_rank  # 24
        ...
        self.dt_proj = nn.Linear(self.dt_rank, self.d_inner, bias=True, **factory_kwargs)   # dt_proj:Linear(in_features=24, out_features=768, bias=True)
