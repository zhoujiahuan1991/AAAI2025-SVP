...
if not SKIP_CUDA_BUILD:
    ...
    check_if_cuda_home_none("causal-conv1d")
    ...
    if CUDA_HOME is not None:
        ...
        if bare_metal_version < Version("11.6"):
            raise RuntimeError(
                "causal-conv1d is only supported on CUDA 11.6 and above.  "
...
def get_package_version():
    with open(Path(this_dir) / "causal-conv1d" / "__init__.py", "r") as f:
