...
class SVHN(VisionDataset):
    ...
    def __getitem__(self, index: int) -> Tuple[Any, Any]:
        ...
        sample = Image.fromarray(np.transpose(img, (1, 2, 0)))
...
#
#     dataset_train = SVHN(args, "train")
#     dataset_val = SVHN(args, "val")
#     dataset_test = SVHN(args, "test")
#     logger.info(dataset_train.classes)
#     logger.info("Nums of classes: {}".format(len(set(dataset_val.labels))))
#     logger.info(
#         "Sample nums: [train]-{}, [val]-{}, [test]-{}".format(len(dataset_train), len(dataset_val), len(dataset_test)))
#
