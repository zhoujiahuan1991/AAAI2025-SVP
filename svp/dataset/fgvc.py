...
logger = logging.getLogger("VimPT")
...
class JSONDataset(torch.utils.data.Dataset):
    def __init__(self, data_path, split, dataset_name, transform, dataset_perc=1.0):
        assert split in {
            "train",
            "val",
            "test",
        ...
        self.data_percentage = dataset_perc
...
class CUB200Dataset(JSONDataset):
    ...
    def __init__(self, root, split, transform):
        ...
        data_path = os.path.join(root, 'FGVC', base_folder)
        super(CUB200Dataset, self).__init__(data_path=data_path, split=split, transform=transform, dataset_perc=1.0, dataset_name="CUB200")
...
class CarsDataset(JSONDataset):
    ...
    def __init__(self, root, split, transform):
        base_folder = "stanford-cars"
        data_path = os.path.join(root, 'FGVC', base_folder)
        super(CarsDataset, self).__init__(data_path=data_path, split=split, transform=transform, dataset_perc=1.0, dataset_name="stanford-cars")
...
class DogsDataset(JSONDataset):
    ...
    def __init__(self, root, split, transform):
        ...
        data_path = os.path.join(root, 'FGVC', base_folder)
        super(DogsDataset, self).__init__(data_path=data_path, split=split, transform=transform, dataset_perc=1.0, dataset_name="stanford-cars")
...
class FlowersDataset(JSONDataset):
    ...
    def __init__(self, root, split, transform):
        base_folder = "OxfordFlower"
        data_path = os.path.join(root, 'FGVC', base_folder)
        super(FlowersDataset, self).__init__(data_path=data_path, split=split, transform=transform, dataset_perc=1.0, dataset_name="stanford-cars")
...
class NabirdsDataset(JSONDataset):
    ...
    def __init__(self, root, split, transform):
        base_folder = "nabirds"
        data_path = os.path.join(root, 'FGVC', base_folder)
        super(NabirdsDataset, self).__init__(data_path=data_path, split=split, transform=transform, dataset_perc=1.0, dataset_name="nabirds")
